...
#
# print("🚀 Coleta + análise + alerta a cada 5 minutos...\n")
#
#
#
# # LOOP PRINCIPAL
...
#
#     # ✅ FILTRO DE TEMPO: 55-65 minutos
#     df = df[(df["Tempo"] >= 55) & (df["Tempo"] <= 65)]
#
#     candidatos = []
#
...
#
#         # ✅ CONDIÇÃO 1: Placar 0 x 0
#         if gols_mandante != 0 or gols_visitante != 0:
#             continue
#
#         # ✅ CONDIÇÃO 2: DaPM > 0.9 para pelo menos um time
#         if row["DaPM_Mandante"] <= 0.9 and row["DaPM_Visitante"] <= 0.9:
#             continue
#
#         # ✅ CONDIÇÃO 3: Finalizações > 4 para pelo menos um time
#         if row["Final_Mandante"] <= 4 and row["Final_Visitante"] <= 4:
#             continue
#
#         # ✅ CONDIÇÃO 4: Escanteios > 6 para pelo menos um time
#         if row["Escanteios_Mandante"] <= 6 and row["Escanteios_Visitante"] <= 6:
#             continue
#
...
#     else:
#         print("🟡 Nenhuma partida com pressão alta e 0x0 entre 55 e 65 min.")
#
#
# try:
#     while True:
...
#     print("🛑 Execução encerrada pelo usuário.")oque seu código principal aqui
